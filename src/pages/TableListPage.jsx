...
export default function TableListPage() {
  ...
  const TableList = itemList.filter((item) => item.category === "table");
  const startIndex = (page - 1) * tablePerPage;
  const currentItems = TableList.slice(startIndex, startIndex + tablePerPage);
